			...
			<div style="width:100%; height:100%; position:absolute; background:url(../../resources/image/common/login.png); background-size: cover">
				<div class="container" >
					<div style="top:400px; width:100%; height:1px; position:relative;" align="center"> 
						<table>
							<tr>
								<td><img src="../../resources/image/common/debec.png" style=" margin-bottom: 30px;"></td>
							</tr>
							<tr>
								<td><input class="form-control" type="text" name="empId" placeholder="ID"  maxlength="12" autofocus required onkeyup="this.value=this.value.replace(/[^a-zA-Z0-9,.]/g,'');" style="margin-bottom: 10px;"></td>
							</tr>
							<tr>
								<td><input class="form-control" type="password" name="empPw" placeholder="Password" maxlength="12" style="margin-bottom: 10px;" onkeydown='javascript:onEnterSubmit()' required></td>
